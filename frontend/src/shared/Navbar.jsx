...
const Navbar = () => {
  ...
  useEffect(() => {}, []);
  return (
    <nav className="w-full bg-gray-100 shadow border-b select-none absolute top-0">
      <section className="max-w-7xl py-3 px-6 flex justify-between items-center mx-auto">
        ...
        <div className="flex justify-end items-center">
          ...
          {location.pathname !== "/sell-product" && (
            <Link
              to={"/sell-product"}
              className="from-violet-700 to-violet-600 shadow-md shadow-violet-500/50 bg-gradient-to-tr text-white px-4 py-2 rounded-full flex justify-center items-center"
            >
              <svg
                width="16px"
                height="16px"
